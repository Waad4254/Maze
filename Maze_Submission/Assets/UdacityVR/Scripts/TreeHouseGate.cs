...
public class TreeHouseGate : MonoBehaviour {
	...
	public void OnDoorClicked () {
		...
		Debug.Log ("'TreeHouseGate.OnDoorClicked()' was called");
        ...
        if (!locked)
        {
            ...
            Collider[] colChildren = GetComponentsInChildren<Collider>();
        ...
        {
            AudioSource.PlayClipAtPoint(DoorLocked, this.transform.position);
        }
	...
	public void Unlock () {
		...
		// Prints to the console when the method is called
		Debug.Log ("'TreeHouseGate.Unlock()' was called");
